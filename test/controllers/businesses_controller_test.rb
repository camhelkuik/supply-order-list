...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { hours: @business.hours, name: @business.name, phone: @business.phone, website: @business.website }
    end
  ...
  test "should update business" do
    patch :update, id: @business, business: { hours: @business.hours, name: @business.name, phone: @business.phone, website: @business.website }
    assert_redirected_to business_path(assigns(:business))
  end
